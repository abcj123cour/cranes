...
picList <- read.csv("C:/Users/JamesK/Downloads/cranes-main/cranes-main/data/cranePics.csv")

# Load BBS data 

countRoutes <- read.csv("C:/Users/JamesK/Downloads/cranes-main/cranes-main/data/countRoutes.csv") 

# Load ebird data

ecranes <- read.csv("C:/Users/JamesK/Downloads/cranes-main/cranes-main/data/ecranes.csv") 
